...
<html>
    ...
    <?php
		...
		for ($i = 1; $i < $limit; $i++) {
			...
			array_push($dataPoints, array("y" => rand(1, 8), "label" => $date));
		}
		// var_dump($dataPoints);
    ?>
    ...
    <body>
        ...
        <script type="text/javascript">
         ...
         <div class="location-list">
             ...
             <a href="https://www.reddit.com/r/Documentaries/comments/5vw009/toxicity_life_at_agbobloshie_the_worlds_largest/" class="location-row" style="font-size:200%">ToxiCity: Life at Agbobloshie, the world's largest e-waste dump in Ghana (2016)</a>
